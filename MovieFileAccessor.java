...
public class MovieFileAccessor extends FileAccessor{
  ...
  */
  ...
  // TODO 1: Implement this method.
      ...
      double releaseYear = Double.parseDouble(array[array.length - 1]);
      double playTime = Double.parseDouble(array[array.length - 2]);
      ...
      if (copy.length == 2) {
         Movie list = new Movie(copy[0], copy[1], playTime, releaseYear);
         movies.addMovie(list);
      }
      else {
         Movie list = new Movie(copy[0], copy[1], copy[2], playTime, releaseYear);
         movies.addMovie(list);
      }
  ...
  */   
  ...
  // TODO 2: Implement this method.
     String string = movie.getTitle() + "," + movie.getDirector() + "," + movie.getGenre() 
                     + "," + movie.getPlayTime() + "," + movie.getReleaseYear();
     return string;
  }
  ...
  */
  ...
  // TODO 3: Implement this method.
     ...
     for (i = 0; i < movieList.getMovieList().size(); ++i) {
         string += movieToCSVString(movieList.getMovieList().get(i)) + "\n";
     }
